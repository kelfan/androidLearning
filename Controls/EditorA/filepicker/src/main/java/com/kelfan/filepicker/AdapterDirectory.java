...
public class AdapterDirectory extends RecyclerView.Adapter<AdapterDirectory.DirectoryViewHolder> {
    ...
    public AdapterDirectory(Context context, List<File> files) {
        mContext = context;
        mFiles = files;
    }
    ...
    public DirectoryViewHolder onCreateViewHolder(ViewGroup parent,
        ...
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.filepicker_file_item, parent, false);
