...
public class FileHandler {
    ...
    public static int append_log_file(String filename, String txt) {
        filename = filename + TimeWorker.getMonth() + ".txt";
        return FileWorker.appendToSecondSD(Constant.DEFAULT_FILE_PATH, filename, txt);
    }

    public static String read_log_file(String filename) {
        filename = filename + TimeWorker.getMonth() + ".txt";
        return FileWorker.readStringFromSecondSD(Constant.DEFAULT_FILE_PATH, filename);
    }
